...
int main(int argc , char **argv)
{
	...
	nh_private.getParam("range_max", range_max);
	nh_private.getParam("range_min", range_min);
	nh_private.getParam("angle_max", angle_max);
	nh_private.getParam("angle_min", angle_min);

	lidar->SetRangeMax(range_max);
	lidar->SetRangeMin(range_min);
	lidar->SetAngleMax(angle_max);
	lidar->SetAngleMin(angle_min);
